...
class VentesService extends __BaseService {
  static readonly findAllPath = '/gestiondestock/v0/ventes/all';
  static readonly savePath = '/gestiondestock/v0/ventes/create';
  static readonly deletePath = '/gestiondestock/v0/ventes/delete/{idVente}';
  static readonly findByCodePath = '/gestiondestock/v0/ventes/{codeVente}';
  static readonly findByIdPath = '/gestiondestock/v0/ventes/{idVente}';
  ...
  findAllResponse(): __Observable<__StrictHttpResponse<Array<VenteDto>>> {
    ...
    let req = new HttpRequest<any>(
      'GET',
      this.rootUrl + `/gestiondestock/v0/ventes/all`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  saveResponse(body?: VenteDto): __Observable<__StrictHttpResponse<VenteDto>> {
    ...
    let req = new HttpRequest<any>(
      'POST',
      this.rootUrl + `/gestiondestock/v0/ventes/create`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  deleteResponse(idVente: number): __Observable<__StrictHttpResponse<null>> {
    ...
    let req = new HttpRequest<any>(
      'DELETE',
      this.rootUrl + `/gestiondestock/v0/ventes/delete/${idVente}`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  findByCodeResponse(codeVente: string): __Observable<__StrictHttpResponse<VenteDto>> {
    ...
    let req = new HttpRequest<any>(
      'GET',
      this.rootUrl + `/gestiondestock/v0/ventes/${codeVente}`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  findByIdResponse(idVente: number): __Observable<__StrictHttpResponse<VenteDto>> {
    ...
    let req = new HttpRequest<any>(
      'GET',
      this.rootUrl + `/gestiondestock/v0/ventes/${idVente}`,
      __body,
      {
        headers: __headers,
        params: __params,
