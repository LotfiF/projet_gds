...
class UtilisateursService extends __BaseService {
  static readonly findAllPath = '/gestiondestock/v0/utilisateurs/all';
  static readonly savePath = '/gestiondestock/v0/utilisateurs/create';
  static readonly deletePath = '/gestiondestock/v0/utilisateurs/delete/{idUtilisateur}';
  static readonly findByMailPath = '/gestiondestock/v0/utilisateurs/find/{mail}';
  static readonly changerMotDePassePath = '/gestiondestock/v0/utilisateurs/update/password';
  static readonly findByIdPath = '/gestiondestock/v0/utilisateurs/{idUtilisateur}';
  ...
  findAllResponse(): __Observable<__StrictHttpResponse<Array<UtilisateurDto>>> {
    ...
    let req = new HttpRequest<any>(
      'GET',
      this.rootUrl + `/gestiondestock/v0/utilisateurs/all`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  saveResponse(body?: UtilisateurDto): __Observable<__StrictHttpResponse<UtilisateurDto>> {
    ...
    let req = new HttpRequest<any>(
      'POST',
      this.rootUrl + `/gestiondestock/v0/utilisateurs/create`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  deleteResponse(idUtilisateur: number): __Observable<__StrictHttpResponse<null>> {
    ...
    let req = new HttpRequest<any>(
      'DELETE',
      this.rootUrl + `/gestiondestock/v0/utilisateurs/delete/${idUtilisateur}`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  findByMailResponse(mail: string): __Observable<__StrictHttpResponse<UtilisateurDto>> {
    ...
    let req = new HttpRequest<any>(
      'GET',
      this.rootUrl + `/gestiondestock/v0/utilisateurs/find/${mail}`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  changerMotDePasseResponse(body?: ChangerMotDePasseUtilisateurDto): __Observable<__StrictHttpResponse<UtilisateurDto>> {
    ...
    let req = new HttpRequest<any>(
      'POST',
      this.rootUrl + `/gestiondestock/v0/utilisateurs/update/password`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  findByIdResponse(idUtilisateur: number): __Observable<__StrictHttpResponse<UtilisateurDto>> {
    ...
    let req = new HttpRequest<any>(
      'GET',
      this.rootUrl + `/gestiondestock/v0/utilisateurs/${idUtilisateur}`,
      __body,
      {
        headers: __headers,
        params: __params,
