...
class FournisseursService extends __BaseService {
  static readonly findAllPath = '/gestiondestock/v0/fournisseurs/all';
  static readonly savePath = '/gestiondestock/v0/fournisseurs/create';
  static readonly deletePath = '/gestiondestock/v0/fournisseurs/delete/{idFournisseur}';
  static readonly findByIdPath = '/gestiondestock/v0/fournisseurs/{idFournisseur}';
  ...
  findAllResponse(): __Observable<__StrictHttpResponse<Array<FournisseurDto>>> {
    ...
    let req = new HttpRequest<any>(
      'GET',
      this.rootUrl + `/gestiondestock/v0/fournisseurs/all`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  saveResponse(body?: FournisseurDto): __Observable<__StrictHttpResponse<FournisseurDto>> {
    ...
    let req = new HttpRequest<any>(
      'POST',
      this.rootUrl + `/gestiondestock/v0/fournisseurs/create`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  deleteResponse(idFournisseur: number): __Observable<__StrictHttpResponse<null>> {
    ...
    let req = new HttpRequest<any>(
      'DELETE',
      this.rootUrl + `/gestiondestock/v0/fournisseurs/delete/${idFournisseur}`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  findByIdResponse(idFournisseur: number): __Observable<__StrictHttpResponse<FournisseurDto>> {
    ...
    let req = new HttpRequest<any>(
      'GET',
      this.rootUrl + `/gestiondestock/v0/fournisseurs/${idFournisseur}`,
      __body,
      {
        headers: __headers,
        params: __params,
