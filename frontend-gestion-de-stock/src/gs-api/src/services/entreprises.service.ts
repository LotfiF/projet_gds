...
class EntreprisesService extends __BaseService {
  static readonly findAllPath = '/gestiondestock/v0/entreprises/all';
  static readonly savePath = '/gestiondestock/v0/entreprises/create';
  static readonly deletePath = '/gestiondestock/v0/entreprises/delete/{idEntreprise}';
  static readonly findByIdPath = '/gestiondestock/v0/entreprises/{idEntreprise}';
  ...
  findAllResponse(): __Observable<__StrictHttpResponse<Array<EntrepriseDto>>> {
    ...
    let req = new HttpRequest<any>(
      'GET',
      this.rootUrl + `/gestiondestock/v0/entreprises/all`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  saveResponse(body?: EntrepriseDto): __Observable<__StrictHttpResponse<EntrepriseDto>> {
    ...
    let req = new HttpRequest<any>(
      'POST',
      this.rootUrl + `/gestiondestock/v0/entreprises/create`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  deleteResponse(idEntreprise: number): __Observable<__StrictHttpResponse<null>> {
    ...
    let req = new HttpRequest<any>(
      'DELETE',
      this.rootUrl + `/gestiondestock/v0/entreprises/delete/${idEntreprise}`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  findByIdResponse(idEntreprise: number): __Observable<__StrictHttpResponse<EntrepriseDto>> {
    ...
    let req = new HttpRequest<any>(
      'GET',
      this.rootUrl + `/gestiondestock/v0/entreprises/${idEntreprise}`,
      __body,
      {
        headers: __headers,
        params: __params,
