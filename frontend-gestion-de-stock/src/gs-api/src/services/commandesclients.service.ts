...
class CommandesclientsService extends __BaseService {
  static readonly findAllPath = '/gestiondestock/v0/commandesclients/all';
  static readonly savePath = '/gestiondestock/v0/commandesclients/create';
  static readonly deleteArticlePath = '/gestiondestock/v0/commandesclients/delete/article/{idCommande}/{idLigneCommande}';
  static readonly deletePath = '/gestiondestock/v0/commandesclients/delete/{idCommandeClient}';
  static readonly findAllLignesCommandesClientByCommandeClientIdPath = '/gestiondestock/v0/commandesclients/lignesCommande/{idCommande}';
  static readonly updateArticlePath = '/gestiondestock/v0/commandesclients/update/article/{idCommande}/{idLigneCommande}/{idArticle}';
  static readonly updateClientPath = '/gestiondestock/v0/commandesclients/update/client/{idCommande}/{idClient}';
  static readonly updateEtatCommandePath = '/gestiondestock/v0/commandesclients/update/etat/{idCommande}/{etatCommande}';
  static readonly updateQuantiteCommandePath = '/gestiondestock/v0/commandesclients/update/quantite/{idCommande}/{idLigneCommande}/{quantite}';
  static readonly findByCodePath = '/gestiondestock/v0/commandesclients/{codeCommandeClient}';
  static readonly findByIdPath = '/gestiondestock/v0/commandesclients/{idCommandeClient}';
  ...
  findAllResponse(): __Observable<__StrictHttpResponse<Array<CommandeClientDto>>> {
    ...
    let req = new HttpRequest<any>(
      'GET',
      this.rootUrl + `/gestiondestock/v0/commandesclients/all`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  saveResponse(body?: CommandeClientDto): __Observable<__StrictHttpResponse<CommandeClientDto>> {
    ...
    let req = new HttpRequest<any>(
      'POST',
      this.rootUrl + `/gestiondestock/v0/commandesclients/create`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  deleteArticleResponse(params: CommandesclientsService.DeleteArticleParams): __Observable<__StrictHttpResponse<CommandeClientDto>> {
    ...
    let req = new HttpRequest<any>(
      'DELETE',
      this.rootUrl + `/gestiondestock/v0/commandesclients/delete/article/${params.idCommande}/${params.idLigneCommande}`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  deleteResponse(idCommandeClient: number): __Observable<__StrictHttpResponse<null>> {
    ...
    let req = new HttpRequest<any>(
      'DELETE',
      this.rootUrl + `/gestiondestock/v0/commandesclients/delete/${idCommandeClient}`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  findAllLignesCommandesClientByCommandeClientIdResponse(idCommande: number): __Observable<__StrictHttpResponse<Array<LigneCommandeClientDto>>> {
    ...
    let req = new HttpRequest<any>(
      'GET',
      this.rootUrl + `/gestiondestock/v0/commandesclients/lignesCommande/${idCommande}`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  updateArticleResponse(params: CommandesclientsService.UpdateArticleParams): __Observable<__StrictHttpResponse<CommandeClientDto>> {
    ...
    let req = new HttpRequest<any>(
      'PATCH',
      this.rootUrl + `/gestiondestock/v0/commandesclients/update/article/${params.idCommande}/${params.idLigneCommande}/${params.idArticle}`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  updateClientResponse(params: CommandesclientsService.UpdateClientParams): __Observable<__StrictHttpResponse<CommandeClientDto>> {
    ...
    let req = new HttpRequest<any>(
      'PATCH',
      this.rootUrl + `/gestiondestock/v0/commandesclients/update/client/${params.idCommande}/${params.idClient}`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  updateEtatCommandeResponse(params: CommandesclientsService.UpdateEtatCommandeParams): __Observable<__StrictHttpResponse<CommandeClientDto>> {
    ...
    let req = new HttpRequest<any>(
      'PATCH',
      this.rootUrl + `/gestiondestock/v0/commandesclients/update/etat/${params.idCommande}/${params.etatCommande}`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  updateQuantiteCommandeResponse(params: CommandesclientsService.UpdateQuantiteCommandeParams): __Observable<__StrictHttpResponse<CommandeClientDto>> {
    ...
    let req = new HttpRequest<any>(
      'PATCH',
      this.rootUrl + `/gestiondestock/v0/commandesclients/update/quantite/${params.idCommande}/${params.idLigneCommande}/${params.quantite}`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  findByCodeResponse(codeCommandeClient: string): __Observable<__StrictHttpResponse<CommandeClientDto>> {
    ...
    let req = new HttpRequest<any>(
      'GET',
      this.rootUrl + `/gestiondestock/v0/commandesclients/${codeCommandeClient}`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  findByIdResponse(idCommandeClient: number): __Observable<__StrictHttpResponse<CommandeClientDto>> {
    ...
    let req = new HttpRequest<any>(
      'GET',
      this.rootUrl + `/gestiondestock/v0/commandesclients/${idCommandeClient}`,
      __body,
      {
        headers: __headers,
        params: __params,
